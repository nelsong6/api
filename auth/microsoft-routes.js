 ...
 *
 * Uses a single JWT signing secret and Microsoft client ID for all apps.
 * The account document is stored in the provided Cosmos container.
 */
export function createMicrosoftRoutes({ jwtSecret, microsoftClientId, accountContainer }) {
  const router = Router();
